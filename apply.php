...
if(isset($_POST['schemebtn'])){
    ...
    $stmt = "INSERT INTO `applied` (`name`,`email`, `schemeid`,`statu`) VALUES ( '$username','$userMail', '$schemeId','1') ";
    ...
    if($result){
        ...
        */
        ...
        $sqla = "INSERT INTO `applied2` (`srno`, `name`, `email`, `scheme`, `status`, `date`, `gender`, `cast`, `district`, `age`) VALUES (NULL, '$fnma', 'ridhampatel2002@gmail.com', '$schemename', 'Applied', current_timestamp(), '$gen', '$caste', '$dis', '$age')";
