...
<head>
  ...
  <title>Jan Suvidha Portal - Index</title>
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          if($_SESSION['loggedin'] == true){
            echo "<li><a class='nav-link scrollto' href='inner-page.php'>Schemes</a></li>";
            echo "<li><a class='nav-link scrollto' href='profile.php'>Profile</a></li>";
            echo "<li><a class='nav-link scrollto' href='status.php'>Status</a></li>";
            echo "<li><a class='nav-link scrollto' href='logout.php'>LogOut</a></li>";
          } else {
            echo "<li class='dropdown'><a href='#'><span>Login</span> <i class='bi bi-chevron-down'></i></a>
            <ul>
          ...
          <!-- <li><a class="nav-link scrollto" href="MBA.html">MBA</a></li> -->
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          ...
          <h1>SUVIDHA</h1>
          <h1>PORTAL</h1>
          <h2>A platform made for indians made by indians </h2>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Why Jan Suvidha Portal ? </h3><br>   
            <ul>
              <li><i class="bi bi-check-circle"></i>Smooth user experience</li>
              <li><i class="bi bi-check-circle"></i>One and only platform from where you can apply for multiple Government schemes.</li>
              <li><i class="bi bi-check-circle"></i>No need to fill details again and again.</li>
              <li><i class="bi bi-check-circle"></i>Updates on whatsapp </li>
              <li><i class="bi bi-check-circle"></i>OTP based login system </li>
              <li><i class="bi bi-check-circle"></i>DGlocker support</li>
            </ul>
